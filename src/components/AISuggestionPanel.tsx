  ...
  return (
    <div className="glass-card rounded-2xl p-6 border border-[#8B5CF6]/30 relative overflow-hidden group">
      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#00E5FF] to-[#8B5CF6] flex items-center justify-center p-[1px]">
          <div className="w-full h-full bg-brand-dark rounded-full flex items-center justify-center">
            <Sparkles className="w-5 h-5 text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#8B5CF6]" fill="currentColor" />
          </div>
        </div>
