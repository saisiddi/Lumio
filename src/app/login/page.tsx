  ...
  return (
    <div className="min-h-screen bg-brand-black flex">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#020617] overflow-hidden items-center justify-center p-12">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-brand-blue/10 via-brand-navy to-[#020617]" />
        ...
        <motion.div 
          ...
          className="relative z-10 glass-card p-12 rounded-3xl max-w-lg shadow-[0_0_50px_rgba(0,229,255,0.1)] border border-brand-blue/20"
        >
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-blue to-brand-violet flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(0,229,255,0.4)]">
          ...
          <p className="text-zinc-400 leading-relaxed font-light">
            Join the world's most innovative teams using Lumion to automate accessibility audits directly into their CI/CD pipeline.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <p className="text-center text-sm text-zinc-500 mt-8">
            ...
            <Link href="/signup" className="text-white hover:text-brand-blue transition-colors font-medium">
              Create one now
            </Link>
          </p>
        </motion.div>
